...
var l = function l2(e2, t2, n2, i2, o2) {
...
var C = function() {
  function Client(e2, t2, n2) {
    void 0 === e2 && (e2 = "/"), void 0 === n2 && (n2 = "en-US"), this.cancelControllers = {}, this.recordServices = {}, this.enableAutoCancellation = true, this.baseUrl = e2, this.lang = n2, this.authStore = t2 || new a(), this.admins = new h(this), this.collections = new b(this), this.logs = new g(this), this.settings = new u(this), this.realtime = new S(this), this.health = new w(this);
  }
...
export {
  ...
  y as LogRequest,
  g as LogService,
  S as RealtimeService,
  o as Record,
  v as RecordService,
  f as SchemaField,
  u as SettingsService,
  C as default,
  getTokenPayload
};
